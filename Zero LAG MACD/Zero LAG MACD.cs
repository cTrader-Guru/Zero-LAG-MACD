...
namespace cAlgo
{
    ...
    [Levels(0)]
    public class ZeroLagMACD_Indicator : Indicator
    {
        ...
        {
            Mq4Double i = 0;
            Mq4Double ZeroLagEMAq = 0;
            Mq4Double ZeroLagEMAp = 0;
            Mq4Double EMA = 0;
            ...
            for (i = 0; i < limit; i++)
            {
                EMA = iMAOnArray(FastEMABuffer, Bars.Count, FastEMA, 0, MODE_EMA, i);
                ZeroLagEMAp = FastEMABuffer[i] + FastEMABuffer[i] - EMA;
                EMA = iMAOnArray(SlowEMABuffer, Bars.Count, SlowEMA, 0, MODE_EMA, i);
                ZeroLagEMAq = SlowEMABuffer[i] + SlowEMABuffer[i] - EMA;
                MACDBuffer[i] = ZeroLagEMAp - ZeroLagEMAq;
            }
            for (i = 0; i < limit; i++)
                SignalEMABuffer[i] = iMAOnArray(MACDBuffer, Bars.Count, SignalEMA, 0, MODE_EMA, i);
            for (i = 0; i < limit; i++)
            {
                EMA = iMAOnArray(SignalEMABuffer, Bars.Count, SignalEMA, 0, MODE_EMA, i);
        ...
        /// </summary>
        public const string NAME = "Zero Lag MACD";
        ...
        /// </summary>
        [Parameter(NAME + " " + VERSION, Group = "Identity", DefaultValue = "https://ctrader.guru/product/zero-lag-macd/")]
        public string ProductInfo { get; set; }


        [Parameter("Fast EMA", Group = "Params", DefaultValue = 12)]
        public int FastEMA_parameter { get; set; }
        bool _FastEMAGot;
        Mq4Double FastEMA_backfield;
        Mq4Double FastEMA
        {
            get
            {
                if (!_FastEMAGot)
                    FastEMA_backfield = FastEMA_parameter;
                return FastEMA_backfield;
            }
            set { FastEMA_backfield = value; }
        }

        [Parameter("Slow EMA", Group = "Params", DefaultValue = 24)]
        public int SlowEMA_parameter { get; set; }
        bool _SlowEMAGot;
        Mq4Double SlowEMA_backfield;
        Mq4Double SlowEMA
        {
            get
            {
                if (!_SlowEMAGot)
                    SlowEMA_backfield = SlowEMA_parameter;
                return SlowEMA_backfield;
            }
            set { SlowEMA_backfield = value; }
        }

        [Parameter("Signal EMA", Group = "Params", DefaultValue = 9)]
        public int SignalEMA_parameter { get; set; }
        bool _SignalEMAGot;
        Mq4Double SignalEMA_backfield;
        Mq4Double SignalEMA
        {
            get
            {
                if (!_SignalEMAGot)
                    SignalEMA_backfield = SignalEMA_parameter;
                return SignalEMA_backfield;
            }
            set { SignalEMA_backfield = value; }
        }

        [Output("MACD", LineColor = "DodgerBlue", PlotType = PlotType.Line)]
        public IndicatorDataSeries MACDBuffer_AlgoOutputDataSeries { get; set; }

        [Output("Signal", LineColor = "Red", PlotType = PlotType.Line)]
        public IndicatorDataSeries SignalBuffer_AlgoOutputDataSeries { get; set; }
        public IndicatorDataSeries FastEMABuffer_AlgoOutputDataSeries { get; set; }
        public IndicatorDataSeries SlowEMABuffer_AlgoOutputDataSeries { get; set; }
        public IndicatorDataSeries SignalEMABuffer_AlgoOutputDataSeries { get; set; }
        ...
        private Mq4OutputDataSeries MACDBuffer;
        private Mq4OutputDataSeries SignalBuffer;
        private Mq4OutputDataSeries FastEMABuffer;
        private Mq4OutputDataSeries SlowEMABuffer;
        private Mq4OutputDataSeries SignalEMABuffer;
        ...
        protected override void Initialize()
        {
            ...
            if (MACDBuffer_AlgoOutputDataSeries == null)
                MACDBuffer_AlgoOutputDataSeries = CreateDataSeries();
            MACDBuffer = new Mq4OutputDataSeries(this, MACDBuffer_AlgoOutputDataSeries, ChartObjects, 2, 0, () => CreateDataSeries(), 1, Colors.Blue);
            AllBuffers.Add(MACDBuffer);
            if (SignalBuffer_AlgoOutputDataSeries == null)
                SignalBuffer_AlgoOutputDataSeries = CreateDataSeries();
            SignalBuffer = new Mq4OutputDataSeries(this, SignalBuffer_AlgoOutputDataSeries, ChartObjects, 0, 1, () => CreateDataSeries(), 1, Colors.Red);
            AllBuffers.Add(SignalBuffer);
            if (FastEMABuffer_AlgoOutputDataSeries == null)
                FastEMABuffer_AlgoOutputDataSeries = CreateDataSeries();
            FastEMABuffer = new Mq4OutputDataSeries(this, FastEMABuffer_AlgoOutputDataSeries, ChartObjects, 12, 2, () => CreateDataSeries(), 1, null);
            AllBuffers.Add(FastEMABuffer);
            if (SlowEMABuffer_AlgoOutputDataSeries == null)
                SlowEMABuffer_AlgoOutputDataSeries = CreateDataSeries();
            SlowEMABuffer = new Mq4OutputDataSeries(this, SlowEMABuffer_AlgoOutputDataSeries, ChartObjects, 12, 3, () => CreateDataSeries(), 1, null);
            AllBuffers.Add(SlowEMABuffer);
            if (SignalEMABuffer_AlgoOutputDataSeries == null)
                SignalEMABuffer_AlgoOutputDataSeries = CreateDataSeries();
            SignalEMABuffer = new Mq4OutputDataSeries(this, SignalEMABuffer_AlgoOutputDataSeries, ChartObjects, 12, 4, () => CreateDataSeries(), 1, null);
            AllBuffers.Add(SignalEMABuffer);

            AllOutputDataSeries.Add(MACDBuffer_AlgoOutputDataSeries);
            AllOutputDataSeries.Add(SignalBuffer_AlgoOutputDataSeries);
            AllOutputDataSeries.Add(FastEMABuffer_AlgoOutputDataSeries);
            AllOutputDataSeries.Add(SlowEMABuffer_AlgoOutputDataSeries);
            AllOutputDataSeries.Add(SignalEMABuffer_AlgoOutputDataSeries);
        ...
        public override void Calculate(int index)
        {
            ...
            {
                _currentIndex = index;
                MACDBuffer.SetCurrentIndex(index);
                SignalBuffer.SetCurrentIndex(index);
                FastEMABuffer.SetCurrentIndex(index);
                SlowEMABuffer.SetCurrentIndex(index);
                SignalEMABuffer.SetCurrentIndex(index);
        ...
        class Mq4OutputDataSeries : IMq4DoubleArray
        {
            ...
            private readonly ZeroLagMACD_Indicator _indicator;

            public Mq4OutputDataSeries(ZeroLagMACD_Indicator indicator, IndicatorDataSeries outputDataSeries, ChartObjects chartObjects, int style, int bufferIndex, Func<IndicatorDataSeries> dataSeriesFactory, int lineWidth, Colors? color = null)
            {
            ...
            public override void Draw()
            {
                ...
                switch (ArrowCode)
                {
                    ...
                    case SYMBOL_LEFTPRICE:
                        ...
                        break;
                    default:
                        arrowString = ZeroLagMACD_Indicator.GetArrowByCode(ArrowCode);
